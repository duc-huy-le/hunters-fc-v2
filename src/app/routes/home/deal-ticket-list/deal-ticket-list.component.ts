...
import { AdsOfferListComponent, AdsOfferListType } from '../../../components/partials/ads-offer-list/ads-offer-list.component';
import { CooperateTicketComponent } from '../../../components/partials/cooperate-ticket/cooperate-ticket.component';
import { CooperateTicketListComponent } from '../../../components/partials/cooperate-ticket-list/cooperate-ticket-list.component';

@Component({
  selector: 'app-deal-ticket-list',
  standalone: true,
  imports: [NgZorroAntdModule, CommonModule, FormsModule, ReactiveFormsModule, CooperateTicketListComponent],
  templateUrl: './deal-ticket-list.component.html',
  styleUrl: './deal-ticket-list.component.css'
})
export class DealTicketListComponent {
